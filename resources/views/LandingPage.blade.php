...
@section('content')
    ...
    <style>
        * {
        ...
        .lp-nav-auth a.register-btn:hover {
            background: #003842;
        }
        ...
        .dest-card-badge.beach {
            background: rgba(2, 132, 199, 0.88);
        }

        .dest-card-badge.landscape {
            background: rgba(22, 101, 52, 0.88);
        }

        .dest-card-badge.marine {
            background: rgba(8, 145, 178, 0.88);
        }

        .dest-card-badge.falls {
            background: rgba(21, 128, 61, 0.88);
        }

        .dest-card-badge.heritage {
            background: rgba(120, 53, 15, 0.88);
        }

        .dest-card-badge.museum {
        ...
        .portal-card-header.establishment {
            background: #136b5a;
        }

        .portal-card-header.personnel {
            background: #1e6b7a;
        }
        ...
        <section class="lp-hero">
            ...
            <div class="lp-hero-content">
                ...
                <p class="lp-hero-desc">
                    An Integrated Tourism Information and Monitoring System that connects tourists, accredited
                    establishments, and the Provincial Tourism Office through tourism information, visitor monitoring, and
            ...
            <div class="lp-section-inner">
                <div class="dest-header">
                    <div class="dest-header-left">
                        ...
                        <p class="section-subtitle">Explore the province's most loved beaches, falls, and heritage sites.
                        </p>
                    </div>
                ...
                <div class="destinations-grid">
                    ...
                    <a href="#" class="dest-card">
                        <div class="dest-card-img">
                            <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&auto=format&fit=crop"
                                alt="Dahican Beach">
                    ...
                    <a href="#" class="dest-card">
                        <div class="dest-card-img">
                            <img src="https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?w=600&auto=format&fit=crop"
                                alt="Sleeping Dinosaur">
                    ...
                    <a href="#" class="dest-card">
                        <div class="dest-card-img">
                            <img src="https://images.unsplash.com/photo-1544550581-5f7ceaf7f992?w=600&auto=format&fit=crop"
                                alt="Pujada Bay">
                    ...
                    <a href="#" class="dest-card">
                        <div class="dest-card-img">
                            <img src="https://images.unsplash.com/photo-1433086966358-54859d0ed716?w=600&auto=format&fit=crop"
                                alt="Aliwagwag Falls">
                    ...
                    <a href="#" class="dest-card">
                        <div class="dest-card-img">
                            <img src="https://images.unsplash.com/photo-1518998053901-5348d3961a04?w=600&auto=format&fit=crop"
                                alt="Cape San Agustin">
                ...
                <div class="footer-grid">
                    ...
                    <div>
                        ...
                        <p class="footer-brand-desc">
                            Provincial Tourism Office of Davao Oriental — the official tourism information and monitoring
