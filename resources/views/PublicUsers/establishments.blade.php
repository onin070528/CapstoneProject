                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <nav class="hidden lg:flex items-center gap-7">
                        ...
                        <a href="/public/establishments"
                            class="text-slate-800 font-semibold text-sm hover:text-[#0e4f5c] transition">Establishments</a>
                        ...
                        <a href="/public/travel-guide"
                            class="text-slate-500 font-medium text-sm hover:text-[#0e4f5c] transition">Travel Guide</a>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="flex flex-wrap items-center gap-4 mb-6">
                    <input type="text" placeholder="Search establishments..."
                        class="border border-slate-300 rounded-md px-4 py-2 text-sm w-72 focus:outline-none focus:border-[#0e4f5c] transition">
                    <select
                        class="border border-slate-300 rounded-md px-4 py-2 text-sm focus:outline-none focus:border-[#0e4f5c] transition">
                        <option>All</option>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div class="bg-white rounded-lg border border-slate-200 overflow-hidden">
                        <div class="relative h-40 bg-[#b3d4d8] flex items-center justify-center">
                            ...
                            <span
                                class="absolute top-3 left-3 bg-[#0e4f5c] text-white text-[10px] font-bold px-2.5 py-1 rounded">RESORT</span>
                        </div>
                        <div class="p-4">
                            <div class="flex items-center justify-between">
                                <h3 class="font-bold text-slate-800 text-sm">Blue Bless Resort</h3>
                                <span
                                    class="text-[10px] font-bold text-teal-600 border border-teal-200 bg-teal-50 px-2 py-0.5 rounded">VERIFIED</span>
                            </div>
                            <p class="text-xs text-slate-400 flex items-center gap-1 mt-1">
                                <i class="fas fa-location-dot text-red-400"></i> Mati City
                            </p>
                            <p class="text-xs text-slate-500 mt-2 leading-relaxed">Beachfront resort along Dahican with
                                private cottages, pool, and surf school.</p>
                            <div class="flex items-center justify-between mt-4">
                                <span class="text-sm text-slate-700 flex items-center gap-1">
                                    <span class="text-amber-400">★</span> 4.7
                                </span>
                                <a href="#"
                                    class="bg-[#0e4f5c] hover:bg-[#0a3d47] text-white text-xs font-medium px-4 py-1.5 rounded-md transition">Register
                                    Visit</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg border border-slate-200 overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-xs text-slate-500 mt-2 leading-relaxed">Family-friendly resort with cabanas,
                                restaurant, and event hall.</p>
                            <div class="flex items-center justify-between mt-4">
                                <span class="text-sm text-slate-700 flex items-center gap-1">
                    ...
                    <div class="bg-white rounded-lg border border-slate-200 overflow-hidden">
                        <div class="relative h-40 bg-[#b3d4d8] flex items-center justify-center">
                            ...
                            <span
                                class="absolute top-3 left-3 bg-[#455a64] text-white text-[10px] font-bold px-2.5 py-1 rounded">HOTEL</span>
                        </div>
                        <div class="p-4">
                            <div class="flex items-center justify-between">
                            ...
                            <p class="text-xs text-slate-500 mt-2 leading-relaxed">Modern hotel in the city center, walking
                                distance to Subangan Museum.</p>
                            <div class="flex items-center justify-between mt-4">
                                <span class="text-sm text-slate-700 flex items-center gap-1">
                    ...
                    <div class="bg-white rounded-lg border border-slate-200 overflow-hidden">
                        <div class="relative h-40 bg-[#b3d4d8] flex items-center justify-center">
                            ...
                            <span
                                class="absolute top-3 left-3 bg-[#2e7d32] text-white text-[10px] font-bold px-2.5 py-1 rounded">LODGE</span>
                        </div>
                        <div class="p-4">
                            <div class="flex items-center justify-between">
                            ...
                            <p class="text-xs text-slate-400 flex items-center gap-1 mt-1">
                                <i class="fas fa-location-dot text-red-400"></i> Cateel
                            </p>
                            <p class="text-xs text-slate-500 mt-2 leading-relaxed">Eco-friendly lodge near Aliwagwag Falls
                                with nature trails.</p>
                            <div class="flex items-center justify-between mt-4">
                                <span class="text-sm text-slate-700 flex items-center gap-1">
                    ...
                    <div class="bg-white rounded-lg border border-slate-200 overflow-hidden">
                        <div class="relative h-40 bg-[#b3d4d8] flex items-center justify-center">
                            ...
                            <span
                                class="absolute top-3 left-3 bg-[#6a1b9a] text-white text-[10px] font-bold px-2.5 py-1 rounded">TOUR
                                OPERATOR</span>
                        </div>
                        <div class="p-4">
                            <div class="flex items-center justify-between">
                            ...
                            <p class="text-xs text-slate-500 mt-2 leading-relaxed">PADI-certified diving and island-hopping
                                tours around Pujada Bay.</p>
                            <div class="flex items-center justify-between mt-4">
                                <span class="text-sm text-slate-700 flex items-center gap-1">
                    ...
                    <div class="bg-white rounded-lg border border-slate-200 overflow-hidden">
                        <div class="relative h-40 bg-[#b3d4d8] flex items-center justify-center">
                            ...
                            <span
                                class="absolute top-3 left-3 bg-[#e65100] text-white text-[10px] font-bold px-2.5 py-1 rounded">RESTAURANT</span>
                        </div>
                        <div class="p-4">
                            <div class="flex items-center justify-between">
                            ...
                            <p class="text-xs text-slate-500 mt-2 leading-relaxed">Local cuisine and specialty coffee in
                                restored heritage house.</p>
                            <div class="flex items-center justify-between mt-4">
                                <span class="text-sm text-slate-700 flex items-center gap-1">
