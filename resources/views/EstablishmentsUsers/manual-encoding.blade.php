    ...
    <div class="space-y-5">
        ...
        <div class="bg-white rounded-xl border border-slate-100 shadow-sm p-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label class="block text-xs font-semibold text-slate-600 mb-1.5">Classification <span
                ...
                <div>
                    <label id="location-label" class="block text-xs font-semibold text-slate-600 mb-1.5">Municipality /
                        Province / Country <span class="text-rose-400">*</span></label>
        ...
        <div class="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="arrival-table w-full text-left border-collapse">
                    <thead>
                        <tr
                            class="bg-slate-50/75 border-b border-slate-100 text-slate-400 text-[10px] font-bold tracking-wider uppercase">
                            <th class="py-3 px-3 w-12 text-center">#</th>
                            <th class="py-3 px-3">Visitor Name <span
                                    class="font-normal normal-case text-slate-300">(Optional)</span></th>
            ...
            <div class="p-4 border-t border-slate-100 flex items-center gap-3">
                <button type="button" onclick="addVisitor()"
                    ...
                    <span
                        class="w-6 h-6 rounded-full bg-slate-100 group-hover:bg-[#0a4e5c]/10 flex items-center justify-center transition-colors">
